...
import { useCancelOutgoingRequestMutation } from '@/redux/features/contactsApi'
import { rtkErrorMesage } from '@/utils/error/errorMessage'
import { useEffect } from 'react'
import toast from 'react-hot-toast'

export default function OutgoingReqeustCard({ card, cardId }) {
  ...
  const cancelRequestFn = () => {
    cancelRequest({ sender_id: cardId, recipient_id: card?._id })
  }
  ...
  return (
    <div className='rounded-lg overflow-hidden relative border shadow-md'>
      ...
      <div className='pt-16 px-3 pb-3'>
        ...
        <button
          className='w-full rounded-full bg-transparent text-red-500 border-red-500 border py-1 text-sm font-medium'
